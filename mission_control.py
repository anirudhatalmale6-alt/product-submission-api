...
def seed_initial_missions():
    ...
    defs = [
        # 1 ── Dog Food Authority Expansion
        {
            ...
            "confidence_pct": 78.5, "risk_level": "medium", "approval_status": "approved",
        ...
        # 2 ── Dog Harness Commercial Opportunity
        {
            ...
            "confidence_pct": 72.3, "risk_level": "low", "approval_status": "approved",
...
_BLG_HARNESS = [
    ("content_brief", "Dog Harness Hub/Guide Brief", "Hub page covering all harness types with navigation to comparison pages."),
    ("content_brief", "Best Dog Harnesses UK Brief", "Comprehensive comparison with testing evidence and ranked recommendations."),
    ("content_brief", "Best No Pull Dog Harnesses UK Brief", "Focused guide on no-pull harnesses with fit and training advice."),
    ("content_brief", "Best Harnesses Small Dogs Brief", "Size-specific guide for small breed harness recommendations."),
    ("content_brief", "Best Harnesses Large Dogs Brief", "Large breed guide with durability focus and fit considerations."),
    ("content_brief", "Puppy Harness Guide Brief", "Age-specific puppy harness guide with growth considerations."),
...
_BLG_CAT_TOYS = [
    ("refresh_recommendation", "Refresh Best Cat Toys UK Page", "Update products, remove discontinued items, refresh evidence sections."),
    ("content_brief", "Cat Toy Comparison Table Brief", "Interactive comparison table with current products and pricing."),
    ("content_brief", "Indoor vs Outdoor Cat Toys Brief", "New content addressing segmented cat toy needs based on lifestyle."),
    ("internal_linking_proposal", "Cat Toys Internal Link Refresh", "Rebuild internal links connecting to cat food and supplies clusters."),
    ("metadata_proposal", "Cat Toys Metadata Refresh", "Update titles and descriptions to reflect refreshed content."),
    ("schema_proposal", "Cat Toys Product Schema Update", "Update structured data to reflect current products and pricing."),
...
_BLG_HOMEPAGE = [
    ("content_brief", "Homepage Category Navigation Redesign Brief", "Redesign category routing for clearer dog/cat pathways."),
    ("content_brief", "Dog Owner Start-Here Section Brief", "Welcoming entry section guiding new dog owners to key content."),
    ("content_brief", "Cat Owner Start-Here Section Brief", "Welcoming entry section guiding new cat owners to key content."),
    ("trust_signal_improvement", "Homepage Trust Signal Components", "Add methodology, about, and evidence components above fold."),
    ("internal_linking_proposal", "Homepage Authority Flow Optimisation", "Restructure homepage links to distribute authority to money pages."),
    ...
    ("customer_journey_improvement", "Editorial Credibility Above Fold", "Add editorial credibility and methodology summary above fold."),
]

_BLG_AI_SEARCH = [
    ("content_brief", "Answer-Ready Summary Templates", "Standardised templates for answer-ready summaries across all clusters."),
    ("content_brief", "Evidence Section Templates", "Evidence section format with source attribution and methodology."),
    ("content_brief", "Direct-Answer Block Templates", "Templates for direct-answer blocks targeting question-intent queries."),
    ("content_brief", "Comparison Summary Templates", "Concise comparison summaries suitable for AI extraction."),
    ("evidence_requirement", "AI Search Readiness Baseline Audit", "Audit current AI Overview citations and entity representation."),
    ("evidence_requirement", "Entity Gap Analysis", "Identify missing entities per cluster for AI search representation."),
    ("schema_proposal", "Citation-Friendly Schema Package", "Structured data optimised for AI search citation and extraction."),
    ("metadata_proposal", "AI-Optimised Heading Structure", "Restructure headings on top 50 pages for AI-parseable extraction."),
    ...
    ("customer_journey_improvement", "AI Referral Landing Experience", "Optimise landing pages for users arriving via AI search citations and summaries."),
]
